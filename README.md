...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-cscal/tags). For example,

```javascript
cscal = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-cscal@v0.0.2-umd/browser.js' )
```
